...
void DEFAULT_CALL TrsProj_SetTransPrecision(int val)
{
...
int DEFAULT_CALL TrsProj_GetTransPrecision(void)
{
...
void DEFAULT_CALL TrsProj_ResetTransPrecision(void)
{
...
void DEFAULT_CALL TrsProj_SetProjection(int cx, int cy, int w, int h, int angle)
{
...
void DEFAULT_CALL TrsProj_SetViewTrsProjEnviro(DRender_tView* Vi)
{
...
void DEFAULT_CALL TrsProj_Transform(LIBCOORD* s, MATRIX3DT* m, LIBCOORD* d)
{
...
void DEFAULT_CALL TrsProj_TransformProjectVertex(MATRIX3DT* m, LIBCOORD* t, int n, LIBCOORD* s, Draw_tVertex* v)
{
...
void DEFAULT_CALL TrsProj_TransformProjectVertex16(MATRIX3DT* m, LIBCOORD* t, int n, COORD16* s, Draw_tVertex* v)
{
