...
void DEFAULT_CALL AIPhysic_CleanUp()
{
...
void DEFAULT_CALL AIPhysic_StartUp()
{
...
void DEFAULT_CALL AIPhysic_Reset(void)
{
...
void DEFAULT_CALL AIPhysic_ResetCar(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_ConfineTrafficCarToRoad(Car_tObj* pCar)
{
...
int DEFAULT_CALL AIPhysic_CalculateLaneChangeSpeed(Car_tObj* pCar, int off, int speed)
{
...
int DEFAULT_CALL AIPhysic_GearTopSpeed(Car_tObj* pCar, int gear)
{
...
int DEFAULT_CALL AIPhysic_GearBottomSpeed(Car_tObj* pCar, int gear)
{
...
void DEFAULT_CALL AIPhysic_HandleShifting(Car_tObj* pCar)
{
...
int DEFAULT_CALL AIPhysic_CalcDeceleration(Car_tObj* pCar, int isOpp, int deltaVel)
{
...
int DEFAULT_CALL AIPhysic_CalcAcceleration(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_SimplePhysics_LongVel(Car_tObj* pCar, int isOpp)
{
...
void DEFAULT_CALL AIPhysic_SimplePhysics_LatVel(Car_tObj* pCar, int isOpp)
{
...
void DEFAULT_CALL AIPhysic_SimplePhysics(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_SetupReleaseFromPurgatory(Car_tObj* theCar)
{
...
void DEFAULT_CALL AIPhysic_PurgatoryPhysics(Car_tObj* theCar)
{
...
int DEFAULT_CALL AIPhysic_CalcFutureLateralVel(Car_tObj* pCar, int currentSlice, int slicesAhead)
{
...
int DEFAULT_CALL AIPhysic_GetPsychoDesiredVector(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_GetDesiredVector(Car_tObj* pCar)
{
...
int DEFAULT_CALL AIPhysic_CalcRoadBend(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_Preperation(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_FinishUp(Car_tObj* pCar)
{
...
int DEFAULT_CALL AIPhysic_OutOfControl(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_InControlPhysics(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_OutOfControlPhysics(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_ChangeDirection(Car_tObj* pCar, int time)
{
...
void DEFAULT_CALL AIPhysic_HandleDirection(Car_tObj* pCar)
{
...
int DEFAULT_CALL AIPhysic_HitWallCheck(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_CoolPhysics(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_CalculateTargetLatPos(Car_tObj* pCar)
{
...
void DEFAULT_CALL AIPhysic_AIPhysics(Car_tObj* pCar)
{
