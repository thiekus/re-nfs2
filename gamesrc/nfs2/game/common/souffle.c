...
void DEFAULT_CALL GetGustWind(DRender_tISouffle* is)
{
...
void DEFAULT_CALL GetAngleWind(DRender_tISouffle* is)
{
...
void DEFAULT_CALL MoveAngleWind(DRender_tISouffle* is)
{
...
DRender_tISouffle* DEFAULT_CALL Souffle_Add(LIBCOORD* soufflept, int type, LIBCOORD* vec)
{
...
void DEFAULT_CALL Souffle_DoSouffle(void)
{
...
void DEFAULT_CALL Souffle_InsertFacet(DRender_tView* Vi)
{
...
void DEFAULT_CALL Souffle_InitTrackSouffle(void)
{
...
void DEFAULT_CALL Souffle_RestartTrackSouffle(void)
{
...
void DEFAULT_CALL Souffle_KillTrackSouffle(void)
{
