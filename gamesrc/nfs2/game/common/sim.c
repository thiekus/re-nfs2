...
void DEFAULT_CALL Sim_CaptureScreen(void)
{
...
void DEFAULT_CALL Sim_StartUp(void)
{
...
void DEFAULT_CALL Sim_Restart(void)
{
...
void DEFAULT_CALL Sim_CleanUp(void)
{
...
void DEFAULT_CALL Sim_ProcessSimSchedules(int time)
{
...
void DEFAULT_CALL Sim_ProcessPause(void)
{
...
int DEFAULT_CALL Sim_CheckForPause(int checkInput)
{
    // 01AF: BLOCK_386
...
void DEFAULT_CALL Sim_MainGameLoop(void)
{
