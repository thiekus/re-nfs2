...
int DEFAULT_CALL AI_GetBestLane(int slice)
{
...
int DEFAULT_CALL AI_GetMaxTrafficOnTrack(void)
{
...
int DEFAULT_CALL AI_GetLifeTimerValue(void)
{
...
int DEFAULT_CALL AI_GetOneWay(void)
{
...
int DEFAULT_CALL AI_GetDriveSide(void)
{
...
void DEFAULT_CALL AI_ProcessBarrierCollision(Car_tObj* pCar)
{
...
void DEFAULT_CALL AI_ProcessCollision(Car_tObj* pCar)
{
...
void DEFAULT_CALL AI_PickNewLane(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_CalcLaneSlack(Car_tObj* theCar)
{
...
int DEFAULT_CALL AI_IsItTimeToStopYet(int carIndex, int slicesPastFinish)
{
...
int DEFAULT_CALL AI_ParallelDistance(Car_tObj* mo, Car_tObj* to)
{
...
int DEFAULT_CALL AI_SliceDistance(int a, int b)
{
...
int DEFAULT_CALL AI_IsDriveableLane(int slice, int laneIndex)
{
...
int DEFAULT_CALL AI_GetProfileMask(int laneIndex)
{
...
int DEFAULT_CALL AI_IsDriveableLane_UsingMask(int slice, int mask)
{
...
int DEFAULT_CALL AI_LaneIndex(int slice, int position)
{
...
void DEFAULT_CALL AI_PutCarOnShoulder(Car_tObj* theCar, int rightShoulder)
{
...
int DEFAULT_CALL AI_IsNonStandardCarFile(int index)
{
...
int DEFAULT_CALL AI_FigureOutPersonalityGameType()
{
...
void DEFAULT_CALL AI_LoadGlueFactor(Udff_tHandle handle)
{
...
void DEFAULT_CALL AI_LoadPhysicsConfig(Udff_tHandle handle)
{
...
void DEFAULT_CALL AI_LoadAIConfig(Udff_tHandle handle)
{
...
void DEFAULT_CALL AI_RestartAICar(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_InitAICar(Car_tObj* mo, Udff_tHandle handle)
{
...
void DEFAULT_CALL AI_CleanUpCollidedCar(Car_tObj* theCar)
{
...
void DEFAULT_CALL CleanUpAllDeadCars(void)
{
...
void DEFAULT_CALL AI_ReInit_SetSpeeds(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_ReInit_PickSliceAndDirection(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_ReInitWith(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_MoveCarToPurgatory(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_ReInit(Car_tObj* theCar)
{
...
int DEFAULT_CALL AI_IsCoordInThisLiveArea(LIBCOORD* tPos, Car_tObj* racer)
{
...
int DEFAULT_CALL AI_IsTrafficCarInAnyLiveArea(Car_tObj* traffic)
{
...
int DEFAULT_CALL AI_IsCoordInThisVisibleArea(LIBCOORD* tPos, Car_tObj* racer)
{
...
int DEFAULT_CALL AI_IsTrafficCarInAnyVisibleArea(Car_tObj* traffic)
{
...
void DEFAULT_CALL AI_EvaluateLife(Car_tObj* theCar)
{
...
void DEFAULT_CALL AI_CalcBestLineMerits(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CalcMeritsBasedOnSpeed(Car_tObj* mo)
{
...
int DEFAULT_CALL AI_IsMellowZone(Car_tObj* mo, int delay)
{
...
void DEFAULT_CALL AI_KeepCarsInLane(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_PushFinishedCarsToSide(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_OpponentBlockPlayer(Car_tObj* mo, Car_tObj* to, int toLaneIndex)
{
...
void DEFAULT_CALL AI_HonkWhenTailgaiting(Car_tObj* mo, Car_tObj* to, int toLaneIndex)
{
...
void DEFAULT_CALL AI_OpponentUpCloseCode(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_OpponentSpecialCase(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CheckForCarsInWay(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CheckForSmackables(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CheckForClearLanes(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CalculateLaneSpeeds(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_SetupOncomingLaneDemerits(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_HandleChangeInNumLanes(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_HandleShouldersAndOffRoad(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_HandleHonkingAndDiving(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_WhichHumanIsLeading(void)
{
...
void DEFAULT_CALL AI_CalculateLaneInfo(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_InitAndCalcBaseMerits(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_ChooseBestLane(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CalculateAdjustedDesiredSpeed(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CalculateDesiredPosition(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_ProcessObservationsAndChooseLane(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CheckForBarriers(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_CalculateRoadYaw(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_Main_OverallSetup(void)
{
...
void DEFAULT_CALL AI_Main_CalcCarInfo(Car_tObj* mo)
{
...
void DEFAULT_CALL AI_Main(Car_tObj* mo)
{
...
int DEFAULT_CALL AI_CalculateOncomingCarSpeed(Car_tObj* theCar)
{
...
int DEFAULT_CALL AI_CalcTrafficSafeSpeed(Car_tObj* theCar, int oldsafe)
{
...
void DEFAULT_CALL AI_CalcPsychoDesiredSpeed(Car_tObj* mo, int top_here)
{
...
void DEFAULT_CALL AI_CalcDesiredSpeed(Car_tObj* mo)
{
...
int DEFAULT_CALL AI_GetHandlingFactor(Car_tObj* mo, int noMercy)
{
...
int DEFAULT_CALL AI_GetAccGlueFactor(Car_tObj* mo, int noMercy)
{
...
int DEFAULT_CALL AI_IntroduceGlue(int leadSlice, int f_glue)
{
...
int DEFAULT_CALL AI_GetGlueFactor(Car_tObj* mo, int noMercy)
{
...
int DEFAULT_CALL AI_GetSpeedFactor(Car_tObj* mo, int noMercy)
{
...
int DEFAULT_CALL AI_LimitTopSpeed(Car_tObj* mo, int f_final)
{
...
void DEFAULT_CALL AI_CalcTrafficSafeSpeedAdjust(Car_tObj* theCar)
{
...
int DEFAULT_CALL AI_GetTrackFactor(Car_tObj* theCar)
{
...
int DEFAULT_CALL AI_CalcAggressiveTopSpeed(Car_tObj* mo)
{
