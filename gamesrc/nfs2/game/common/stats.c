...
void DEFAULT_CALL Stats_DoPlayerGlue(void)
{
...
void DEFAULT_CALL Stats_ClearPosition(void)
{
...
int DEFAULT_CALL Stats_GetPosition(Car_tObj* carObj)
{
...
int DEFAULT_CALL Stats_GetNumOpponents(void)
{
...
Car_tObj* DEFAULT_CALL Stats_GetNextCar(int position)
{
...
void DEFAULT_CALL Stats_TrackStats(Car_tObj* carObj)
{
...
void DEFAULT_CALL Stats_ExtrapolateOpponentTimes(int type)
{
...
void DEFAULT_CALL Stats_TrackEndGame(void)
{
