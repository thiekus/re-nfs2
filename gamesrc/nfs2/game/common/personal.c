...
GAME_FUNC
// STUB: NFSW 0x004313d7
char* DEFAULT_CALL Personality_GetName(personality_t* personality)
{
...
GAME_FUNC
// STUB: NFSW 0x0043140c
void DEFAULT_CALL Personality_HardLoad()
{
...
GAME_FUNC
// STUB: NFSW 0x00431435
void DEFAULT_CALL Personality_CleanUp()
{
...
GAME_FUNC
// STUB: NFSW 0x0043144a
void DEFAULT_CALL Personality_StartUp()
{
...
GAME_FUNC
// STUB: NFSW 0x00431464
int DEFAULT_CALL Personality_GetPersonalityIndex(int startingPosition, int pGameType)
{
...
GAME_FUNC
// STUB: NFSW 0x004314b7
personality_t* DEFAULT_CALL Personality_ChoosePersonality(int personalityIndex)
{
